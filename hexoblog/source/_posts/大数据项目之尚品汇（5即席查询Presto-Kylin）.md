...
{% asset_img Presto简介.jpg This is an example image %}

### 1.1.2 Presto架构

{% asset_img Presto架构.png This is an example image %}

### 1.1.3 Presto优缺点

{% asset_img Presto优缺点.png This is an example image %}
...
{% asset_img 查看表结构.png This is an example image %}
...
{% asset_img 配置的Catalog.png This is an example image %}

每个表后面都有个复制键，点一下会复制完整的表名，然后再上面框里面输入sql语句，ctrl+enter键执行显示结果

{% asset_img 执行显示结果.png This is an example image %}
...
{% asset_img Kylin架构.png This is an example image %}
...
{% asset_img 前后保留空格.png This is an example image %}
...
{% asset_img 查看Web页面.png This is an example image %}
...
{% asset_img Submit按钮提交.png This is an example image %}

### 2.3.2 获取数据源

1）点击DataSource

{% asset_img 点击DataSource.png This is an example image %}

2）点击下图按钮导入Hive表

{% asset_img 导入Hive表.png This is an example image %}
...
{% asset_img 点击Sync按钮.png This is an example image %}
...
{% asset_img 点击Models.png This is an example image %}

2）填写Model信息，点击Next

{% asset_img 填写Model.png This is an example image %}

3）指定事实表

{% asset_img 指定事实表.png This is an example image %}

4）选择维度表，并指定事实表和维度表的关联条件，点击Ok

{% asset_img 选择维度表.png This is an example image %}

{% asset_img 选择维度表1.png This is an example image %}

维度表添加完毕之后，点击Next

{% asset_img 选择维度表2.png This is an example image %}

5）指定维度字段，并点击Next

{% asset_img 指定维度字段.png This is an example image %}

6）指定度量字段，并点击Next

{% asset_img 指定度量字段.png This is an example image %}

7）指定事实表分区字段（仅支持时间分区），点击Save按钮，model创建完毕

{% asset_img 指定事实表分区字段.png This is an example image %}

### 2.3.4 构建cube

1）点击new， 并点击new cube

{% asset_img 点击new.png This is an example image %}

2）填写cube信息，选择cube所依赖的model，并点击next

{% asset_img 填写cube信息.png This is an example image %}

3）选择所需的维度，如下图所示

{% asset_img 选择所需的维度.png This is an example image %}

{% asset_img 选择所需的维度1.png This is an example image %}

4）选择所需度量值，如下图所示

{% asset_img 选择所需度量值.png This is an example image %}

{% asset_img 选择所需度量值1.png This is an example image %}

4）cube自动合并设置，cube需按照日期分区字段每天进行构建，每次构建的结果会保存在Hbase中的一张表内，为提高查询效率，需将每日的cube进行合并，此处可设置合并周期。

{% asset_img cube自动合并设置.png This is an example image %}

5）Kylin高级配置（优化相关，暂时跳过）

{% asset_img Kylin高级配置.png This is an example image %}

6）Kylin相关属性配置覆盖

{% asset_img Kylin相关属性配置覆盖.png This is an example image %}

7）Cube信息总览，点击Save，Cube创建完成

{% asset_img Cube信息总览.png This is an example image %}

8）构建Cube（计算），点击对应Cube的action按钮，选择build

{% asset_img 构建Cube.png This is an example image %}

9）选择要构建的时间区间，点击Submit

{% asset_img 构建的时间区间.png This is an example image %}

10）点击Monitor查看构建进度

{% asset_img 查看构建进度.png This is an example image %}
...
{% asset_img 错误.png This is an example image %}
...
{% asset_img 维度跟度量.png This is an example image %}
...
{% asset_img 逐层构建算法.png This is an example image %}
...
{% asset_img N次MapReduce Job.png This is an example image %}
...
{% asset_img 快速构建算法.png This is an example image %}
...
{% asset_img 逐段”(By Segment) 或“逐块”(By Split).png This is an example image %}
...
{% asset_img Cube存储原理.png This is an example image %}

{% asset_img Cube存储原理1.png This is an example image %}
...
{% asset_img 衍生维度.png This is an example image %}
...
{% asset_img 强制维度.png This is an example image %}
...
{% asset_img 层级维度.png This is an example image %}
...
{% asset_img 联合维度.png This is an example image %}

这些操作可以在Cube Designer的Advanced Setting中的Aggregation Groups区域完成，如下图所示。

{% asset_img Aggregation Groups.png This is an example image %}
...
{% asset_img 过滤的维度.png This is an example image %}

2）基数大的维度放在基数小的维度前边。

{% asset_img 基数大的维度.png This is an example image %}
...
{% asset_img 结果展示.png This is an example image %}
...
{% asset_img 网页查看.png This is an example image %}

2）配置Zepplin支持Kylin
（1）点击右上角anonymous选择Interpreter

{% asset_img 选择Interpreter.png This is an example image %}

（2）搜索Kylin插件并修改相应的配置

{% asset_img 搜索Kylin插件.png This is an example image %}

（3）修改完成点击Save完成

{% asset_img Save完成.png This is an example image %}

3）案例实操
需求：查询员工详细信息，并使用各种图表进行展示
（1）点击Notebook创建新的note

{% asset_img 新的note.png This is an example image %}

（2）填写Note Name点击Create

{% asset_img 点击Create.png This is an example image %}

{% asset_img 点击Create1.png This is an example image %}

（3）执行查询

{% asset_img 执行查询.png This is an example image %}

（4）结果展示

{% asset_img 结果展示1.png This is an example image %}

（5）其他图表格式

{% asset_img 图表格式.png This is an example image %}

{% asset_img 图表格式1.png This is an example image %}

{% asset_img 图表格式2.png This is an example image %}

{% asset_img 图表格式3.png This is an example image %}

{% asset_img 图表格式4.png This is an example image %}

[大数据项目之尚品汇（6集群监控Zabbix）](https://bigworldxld.github.io/2022/02/11/undefined.html)
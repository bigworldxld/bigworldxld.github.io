---
title: wireshark使用
img: https://bigworldxld.github.io/picx-images-hosting/images/wireshark.webp
categories: tools
tags:
  - wireshark
  - ISO
...
![wireshark界面](https://bigworldxld.github.io/picx-images-hosting/images/wireshark界面.webp)
...
![wireshark过滤器](https://bigworldxld.github.io/picx-images-hosting/images/wireshark过滤器.webp)

2. Packet List Pane(数据包列表)， 显示捕获到的数据包，每个数据包包含编号，时间戳，源地址，目标地址，协议，长度，以及数据包信息。 不同协议的数据包使用了不同的颜色区分显示。

![wireshark数据包列表](https://bigworldxld.github.io/picx-images-hosting/images/wireshark数据包列表.webp)

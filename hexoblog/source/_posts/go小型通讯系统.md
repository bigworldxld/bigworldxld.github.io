...
{% asset_img 界面设计.jpg This is an example image %}                                      
...
{% asset_img 客户端登录菜单.jpg This is an example image %}        
...
{% asset_img 服务器开启监听.jpg This is an example image %}        
...
{% asset_img 注册用户.jpg This is an example image %}  

在Redis中查看用户

{% asset_img 查看用户.jpg This is an example image %}  

服务器端传输的信息

{% asset_img 服务器端传输.jpg This is an example image %}  

登录用户

{% asset_img 登录用户.jpg This is an example image %}  

服务器端显示的登录信息

{% asset_img 登录信息.jpg This is an example image %}  

显示当前登录和发送消息

{% asset_img 登录和发送.jpg This is an example image %}  

服务器端显示的发送信息

{% asset_img 发送信息.jpg This is an example image %}  
...
{% asset_img 编译clinet和server.jpg This is an example image %}  

{% asset_img 编译clinet和server1.jpg This is an example image %}  

开一个服务器，三个客户端，登录进行群发

{% asset_img 进行群发.jpg This is an example image %}  

在id为102的用户上查看在线用户

{% asset_img 查看在线用户.jpg This is an example image %}  

在id为102的用户上进行群发

{% asset_img 用户上进行群发.jpg This is an example image %}  

对应服务器中的数据变化

{% asset_img 数据变化.jpg This is an example image %}  

退出

{% asset_img 退出.jpg This is an example image %}  
---
title: 大数据项目之尚品汇（2业务数据采集平台)
date: 2022-02-06 20:46:55
...
{% asset_img 电商业务流程.png This is an example image %}
...
{% asset_img SKU和SPU.png This is an example image %}
...
{% asset_img 平台属性.png This is an example image %}

2）销售属性

{% asset_img 销售属性.png This is an example image %}
...
{% asset_img 电商业务表.png This is an example image %}

{% asset_img 后台管理系统.png This is an example image %}
...
{% asset_img 连接数据库.png This is an example image %}

### 2.2.2 建表语句

1）通过SQLyog创建数据库

{% asset_img 创建数据库.png This is an example image %}

2）设置数据库名称为gmall，编码为utf-8，排序规则为utf8_general_ci

{% asset_img 设置数据库名称.png This is an example image %}

3）导入数据库结构脚本（gmall.sql）

{% asset_img 导入数据库结构脚本.png This is an example image %}
...
{% asset_img 新建模型.png This is an example image %}

（2）命名模型

{% asset_img 命名模型.png This is an example image %}

（3）点击图标，选中模型

{% asset_img 选中模型.png This is an example image %}

（4）导入数据库

{% asset_img 导入数据库.png This is an example image %}
...
{% asset_img 选择导入的表.png This is an example image %}

（7）建立表关系
第一步：点击选中主表（主键所在的表）

{% asset_img 选中主表.png This is an example image %}

第二步：点击连接按钮

{% asset_img 点击连接.png This is an example image %}

第三步：点击从表，配置连接条件

{% asset_img 点击从表.png This is an example image %}

第四步：效果展示

{% asset_img 效果展示.png This is an example image %}

3）使用技巧
（1）缩略图

{% asset_img 缩略图.png This is an example image %}
...
{% asset_img 全量同步策略.png This is an example image %}

### 2.4.2 增量同步策略

{% asset_img 增量同步策略.png This is an example image %}

### 2.4.3 新增及变化策略

{% asset_img 新增及变化策略.png This is an example image %}
...
{% asset_img 分析表同步策略.png This is an example image %}
...
[大数据项目之尚品汇（3数据仓库系统）](https://bigworldxld.github.io/2022/02/07/undefined.html)

...
AOE – Area Effect Damage，区域作用魔法，群攻
...
Buff – 主要指辅助类角色为别人施加的有益状态，增加防御、回血速度、躲避率等
...
DBUFF – De-Buff，对怪物或敌对玩家施放的具有负面状态
...
Dungeon – 指地宫，多指游戏中难度很大的地形

Doom-like：三维射击类游戏

E3（Electronic Entertainment Expo）：美国E3大展，最为盛大的电脑游戏与电视游戏的商贸展示会，基本于每年五月举行

Easter Egg：复活节彩蛋，隐藏着的一段意外的内容，常为制作者设计的搞笑内容
...
Gameplay：游戏可玩性。即游戏的玩法

Genre：游戏类型，比如角色扮演类、冒险类、动作类、模拟类等。
...
HUD（Heads Up Display）：飞行仪表盘，常提供玩家诸如弹药状况、速度、目标跟踪等作战信息。
...
LOL – Lots of Laugh/Laughing Out Loud的简写，指大笑，很常用的聊天词汇，相当于汉语中的”呵呵”、”哈哈”等，ROFL(笑到打滚)

LOM – Low on Mana的简写，法力不足
Login – 与Logon, Log-in意义相同，表示登入账号
...
Nerf – 消弱
Nerve – 神经，多指游戏角色的属性
Newbie （Newb）– 菜鸟，形容新玩家

Ninja – 没有经过相关玩家允许或趁别人没注意而拿走战利品
N00b – 一种用来称呼新人的不礼貌的说法
**NPC** – Non-Player-Controlled Character，非玩家控制的角色，纯粹的电脑角色

OBT – Open Beta Test 游戏公开测试
OOM – Out of Mana的简写，法力耗尽
...
Pulling – 队伍中的玩家负责吸引一只或几只怪物，并将他们带到队伍所在地，集体杀怪，这多指高级怪物的情况下

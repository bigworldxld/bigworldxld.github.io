...
{% asset_img 认证原理.png This is an example image %}
...
| ***\*D\*******\*ataNode\****        | hadoop103          | dn/hadoop103                |
| ***\*DataNode\****                  | hadoop104          | dn/hadoop104                |
| ***\*Secondary NameNode\****        | hadoop104          | sn/hadoop104                |
| ***\*Resource\*******\*Manager\**** | hadoop103          | rm/hadoop103                |
| ***\*N\*******\*odeManager\****     | hadoop102          | nm/hadoop102                |
| ***\*N\*******\*odeManager\****     | hadoop103          | nm/hadoop103                |
...
{% asset_img 火狐浏览器.png This is an example image %}

２）搜索“network.negotiate-auth.trusted-uris”，修改值为要访问的主机名（hadoop102）

{% asset_img 访问的主机.png This is an example image %}

3）搜索“network.auth.use-sspi”，双击将值变为false

{% asset_img 值变为false.png This is an example image %}

3.认证
１）启动Kerberos客户端，点击Get Ticket

{% asset_img 点击Get.png This is an example image %}
...
{% asset_img 认证成功.png This is an example image %}

4.访问HDFS

{% asset_img 访问HDFS.png This is an example image %}

5.注销认证

{% asset_img 注销认证.png This is an example image %}

6.重启浏览器，再次访问HDFS

{% asset_img 重启浏览器.png This is an example image %}
...
{% asset_img 创建Driver.png This is an example image %}

2.配置Driver

{% asset_img 配置Driver.png This is an example image %}
...
{% asset_img 基础配置.png This is an example image %}

注：
url：jdbc:hive2://hadoop102:10000/;principal=hive/hadoop102@EXAMPLE.COM
2）高级配置

{% asset_img 高级配置.png This is an example image %}
...
5）将上一步生成的atguigu.keytab文件，置于Windows中的特定路径，该路径须与3）中的keyTab属性的值保持一致。
6）测试连接

{% asset_img 测试连接.png This is an example image %}

[大数据项目之尚品汇（8安全环境实战）](https://bigworldxld.github.io/2022/02/13/undefined.html)
...
tags: stack
cover: true
coverImg: /images/algorithm.jpg
img: /images/algorithm.jpg
categories: algorithm
abbrlink: 39393
date: 2022-01-05 17:05:53
---
...
+ 用数组模拟栈的使用，由于栈是一种有序列表，当然可以使用数组的结构来储存栈的数据内容， 下面我们就用数组模拟栈的出栈，入栈等操作。
  ...
  {% asset_img 数组模拟栈的思路.png This is an example image %}
...
+ 2举例说明:
  ...
  {% asset_img 中缀表达式转换为后缀表达式.png This is an example image %}
